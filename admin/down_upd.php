          ...
          <tr>
            <td align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
              <tr>
                ...
                <td align="center"><p style="margin-top:3px"><a href="down_list.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">下载列表</a></p></td>
                </tr>
            </table></td>
          </tr>
        </table>
...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
      <td width="120" align="right" bgcolor="#FFFFFF"><strong>下载名称：</strong></td>
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>下载分类：</strong></td>
      <td bgcolor="#FFFFFF"><select name="cat_id" id="select">
        <option value="">请选择下载分类</option>
       			<?php
                    sub_class(227,"",$row['cat_id']);
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="200"><input name="down_src" type="text" style="width:450px;" class="inputuser" onBlur="this.className='inputuser'" onFocus="this.className='inputuser-bor'"></td>
            <td><?=$row['img_thumb']?></td>
    ...
    <tr style="display:none">
      <td align="right" bgcolor="#FFFFFF"><strong>下载价格：</strong></td>
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>限制：</strong></td>
      <td bgcolor="#FFFFFF"><select name="xiazai">
          <option  value="0">不限制</option>
		   <option  value="1">正式会员下载</option>
        </select></td>
    </tr>
...
function selectTag(showContent,selfObj)
{
  ...
  <tr>
    <td align="center" height="25">
          <center>
           <a href="http://www.wkcx.net" target="_blank">技术支持：子长县人民检察院 </a>
          </center></td>
  </tr>
</table>
<?php
	if($act == 'update')
	{
		...
		{
    		$dir = "../uploadfile/".date("Y-m-d",time()+3600*8)."/";
    		$i=1;
    		if(!is_dir($dir))
			{
       			mkdir($dir,0777);
		...
		$xiazai= !empty($_POST['xiazai']) ? trim($_POST['xiazai']) : '0';
		...
		$img_thumb1 = !empty($_POST['down_src']) ? $_POST['down_src'] : '';
		$img_thumb = "file/".$img_thumb1;
		/*上传附件*/
		/*if(!empty($_FILES['img_thumb']['name']))
		{
			...
			@move_uploaded_file($_FILES['img_thumb']['tmp_name'], $uploadfile);
			
			$img_thumb = str_replace("../","",$uploadfile);
		}*/
		if(!empty($img_thumb))
		{	
			$sql = "UPDATE wkcx_content SET   cat_id='$cat_id',xiazaiid='$xiazai',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',img_thumb='$img_thumb',small_img ='$small_img ',news_url='$news_url',news_order='$news_order' WHERE id='$id'";
		}
		else
		{
			$sql = "UPDATE wkcx_content SET cat_id='$cat_id',xiazaiid='$xiazai',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',news_url='$news_url',news_order='$news_order' WHERE id='$id'";
		}
		//echo $sql;
		//exit; 
		$url = "down_list.php?curPage=".$curPage;
		if($db->query($sql))
		{
			urlMsg('修改成功',$url);
		}
