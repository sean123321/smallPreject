...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> > 品牌修改</td>
  </tr>
  <tr>
          ...
          <tr>
            <td align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
              <tr>
                ...
                <td align="center"><p style="margin-top:3px"><a href="notic_list.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">品牌列表</a></p></td>
                </tr>
            </table></td>
          </tr>
        </table>
...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
      <td width="120" align="right" bgcolor="#FFFFFF"><strong>品牌：</strong></td>
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>品牌简介：</strong></td>
...
<?php
	if($act == 'update')
	{
		...
		if(!empty($img_thumb))
		{	
			$sql = "UPDATE wkcx_content SET cat_id='$cat_id',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',img_thumb='$img_thumb',small_img ='$small_img ',news_url='$news_url',news_order='$news_order' WHERE id='$id'";
		}
		else
		{
			$sql = "UPDATE wkcx_content SET cat_id='$cat_id',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',news_url='$news_url',news_order='$news_order' WHERE id='$id'";
		}
		$url = "brand_list.php?curPage=".$curPage;
		if($db->query($sql))
		{
			urlMsg('修改成功',$url);
		}
