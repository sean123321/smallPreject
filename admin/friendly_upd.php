...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
          ...
          <tr>
            <td align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
              <tr>
                ...
                <td align="center"><p style="margin-top:3px"><a href="news_list.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">资讯列表</a></p></td>
                </tr>
            </table></td>
          </tr>
        </table>
  ...
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input type="file" name="img_thumb" id="img_thumb">&nbsp;&nbsp;<img src="../<?=$row['img_thumb']?>" height="30">
      </td>
      </tr>
    <tr>
...
<?php
	if($act == 'update')
	{
		...
		if(!empty($img_thumb))
		{
			$sql = "UPDATE wkcx_content SET cat_id='$cat_id',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',img_thumb='$img_thumb',news_url='$news_url' WHERE id='$id'";
		}
		else
		{
			echo $sql = "UPDATE wkcx_content SET cat_id='$cat_id',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',news_url='$news_url' WHERE id='$id'";
		}
