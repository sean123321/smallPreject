...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> > 视频修改</td>
  </tr>
  <tr>
    <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#D2FFD2" style="border:1px solid #BCE8B5">
          <tr>
            <td align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
              <tr>
                ...
                <td align="center"><p style="margin-top:3px"><a href="shipin_list.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">信息列表</a></p></td>
                </tr>
            </table></td>
          </tr>
        </table>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <form action="?act=update&id=<?=$id?>&curPage=<?=$curPage?>" method="post" enctype="multipart/form-data" name="form1" onSubmit="return check();">      <input type="hidden" name="cat_id" value="138"><tr>
              <td><DIV id=con>
<UL id=tags>
...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>是否首页推荐：</strong></td>
      <td bgcolor="#FFFFFF"><input type="radio" name="tuijian" value="yes"  <?php if(@$row['tuijian']=='yes'){?> <?php echo"checked "; }?>>
        是　　
          <input name="tuijian" type="radio" value="no" <?php if(@$row['tuijian']=='no'){?> <?php echo"checked "; }?>>
          否　　          </td>
    </tr>
    <tr>
...
<textarea style="display:none" name="content" id="content"><?=@$row['news_content']?></textarea>
<iframe id="myiframe" src="../edit/editor.htm?id=content&ReadCookie=0" frameborder="0" scrolling="no" width="621" height="460"></iframe>
</DIV>
</DIV>
</DIV>
<SCRIPT type=text/javascript>
...
<?php
	if($act == 'update')
	{
		...
		if(!empty($_FILES['img_thumb']['name']))
		{
			...
			if(move_uploaded_file($_FILES['img_thumb']['tmp_name'], $uploadfile)) 
			{
				$img_thumb = str_replace("../", "", $uploadfile); 
			}
		}
		if(!empty($img_thumb))
		{	
			$sql = "UPDATE wkcx_content SET cat_id='$cat_id',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',img_thumb='$img_thumb',small_img ='$small_img ',news_url='$news_url',news_order='$news_order',tuijian='$tuijian' WHERE id='$id'";
		}
		else
		{
			$sql = "UPDATE wkcx_content SET cat_id='$cat_id',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',news_url='$news_url',news_order='$news_order',tuijian='$tuijian' WHERE id='$id'";
		}
		$url = "shipin_list.php?curPage=".$curPage;
		if($db->query($sql))
		{
			
			urlMsg('修改成功',$url);exit();
		}
		else
		{
			goBakMsg("修改失败");	exit();
