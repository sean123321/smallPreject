...
<?php
	...
	if($act == 'update')
	{
		...
		if(!empty($img_thumb))
		{	
			$sql = "UPDATE wkcx_content SET cat_id='$cat_id',address='$address',price='$price',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',img_thumb='$img_thumb',small_img ='$small_img ',news_url='$news_url',news_order='$news_order' WHERE id='$id'";
		}
		else
		{
			$sql = "UPDATE wkcx_content SET cat_id='$cat_id',address='$address',price='$price',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',news_url='$news_url',news_order='$news_order' WHERE id='$id'";
		}
