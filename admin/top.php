    ...
    <td class="topbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="600"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="490" height="25" align="right"><table width="74%" border="0" align="right" cellpadding="2" cellspacing="1" bgcolor="#D1FFBB">
                <tr>
                  <td bgcolor="#FFFF66">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="258" align="center" nowrap="nowrap">您好： 
      <?php session_start();echo $_SESSION['username']?> 
    欢迎您登陆本系统！
                    </td>
    <td width="160" align="center"><span id="jnkc">
      <script>setInterval("jnkc.innerHTML=new Date().toLocaleString()+' '.charAt(new Date().getDay());",1000);</script></span></td>
  </tr>
</table>
