...
<?php
	if($act == 'update')
	{
		...
		if($cat_id==311)
		{
				 ...
				 $sql = "SELECT * FROM wkcx_content   WHERE img_thumb!=''  and cat_id in(311) ORDER BY  add_time DESC LIMIT 0,6";
						$res = $db->query($sql);
						$dd="";
	...
	if($cat_id==254)
		{
				 ...
				 $sql = "SELECT * FROM wkcx_content   WHERE img_thumb!=''  and cat_id in(254) ORDER BY  add_time DESC LIMIT 0,6";
						$res = $db->query($sql);
						$dd="";
