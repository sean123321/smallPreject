...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> > 添加企业</td>
  </tr>
  <tr>
...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
	...
	<tr>
      <td align="right" bgcolor="#FFFFFF"><strong>信息来源
：</strong></td>
      <td bgcolor="#FFFFFF"><input name="laiyuan" type="text" class="inputuser" id="laiyuan" style="width:100px;" onBlur="this.className='inputuser'" size="100">        
        　　      </td>
    </tr>
    <tr>
...
<?php
	...
	if($act == 'add')
	{
		...
		$sql = "INSERT INTO wkcx_content(cat_id,laiyuan,news_title,news_desc,news_content,add_time,img_thumb,news_url,type,news_order,small_img) 
						VALUES('$cat_id','$laiyuan','$news_title','$news_desc','$news_content','$add_time','$img_thumb','$news_url','1','$news_order','$small_img')";
		
		if($db->query($sql))
		{
			
			urlMsg('添加成功','com_list.php');
		}
		else
		{
			goBakMsg("添加失败");	
