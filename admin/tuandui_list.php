    ...
    <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <option value="">请选择产品分类</option>
              ...
              <td width="152" align="center"><input name="start_addtime" type="text" value="<?=$start_addtime?>" style="width:150px" class="inputuser" onBlur="this.className='inputuser'" onFocus="this.className='inputuser-bor';setday(this);" ></td>
              <td width="5" align="center">-</td>
              <td width="152" align="center"><input name="end_addtime" type="text" value="<?=$end_addtime?>" style="width:150px" class="inputuser" onBlur="this.className='inputuser'" onFocus="this.className='inputuser-bor';setday(this);"></td>
              <td width="342"><input name="keywords" type="text" value="<?=$keywords?>" style="width:100%" class="inputuser" onBlur="this.className='inputuser'" onFocus="this.className='inputuser-bor'; this.value=''"></td>
              <td width="67"><input name="Submit" type="submit" class="button" value="立即搜索" onMouseMove="this.className='button-bor'" onMouseOut="this.className='button'" ></td>
              <td width="93" align="right"><table width="93" height="22" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
                  <tr>
                    <td align="center"><img src="images/icon_add.gif" width="16" height="16"></td>
                    <td align="center"><p style="margin-top:3px"><a href="tuandui_add.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">添加团队信息</a></p></td>
                  </tr>
              </table></td>
            </tr></form>
          </table>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#BCE8B5">
            <tr>
              ...
              <td align="center" background="images/list_title_bg.jpg"><strong>产品名称</strong></td>
...
$countSql="SELECT a.id FROM wkcx_content AS a,wkcx_class AS b WHERE a.cat_id=b.id $sqlwhere AND b.type='tuandui'";//sql语句
...
$sql = "SELECT a.id AS id,news_title,class_name,add_time,news_order,img_thumb FROM wkcx_content AS a,wkcx_class AS b WHERE a.cat_id=b.id $sqlwhere  AND b.type='tuandui' ORDER BY news_order ASC,add_time DESC LIMIT $rsStart, $pageSize";
$res = $db->query($sql);
$i = 1;
