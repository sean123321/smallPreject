	...
	<form id="form1" name="form1" method="post" action="logincheck.php" onSubmit="return fLoginFormSubmit();">
      <table width="100%" height="233" border="0" cellpadding="0" cellspacing="1">
        ...
        <tr>
          ...
          <td><input type="password" name="password" style="width:160px;" class="border" onFocus="fEvent('focus',this)" onBlur="fEvent('blur',this)" onMouseOver="fEvent('mouseover',this)" onMouseOut="fEvent('mouseout',this)" maxlength="10" /></td>
        </tr>
        <tr>
...
<table width="830" height="40" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="40" align="center">网一管家网站管理系统&nbsp;系统版本：V9.08&nbsp;</td>
  </tr>
</table>
</body>
</html>
