...
<table width="101%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：品牌管理 > 品牌列表</td>
  </tr>
  <tr>
        ...
        <td valign="top">
          <table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#D2FFD2" style="border:1px solid #BCE8B5">
            <form name="form1" method="post" action=""><tr>
              <td width="90" align="center"><b>品牌名称：</b></td>
              ...
              <tr>
                ...
                <td align="center"><p style="margin-top:3px"><a href="brand_add.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">添加品牌</a></p></td>
                </tr>
            </table></td>
            </tr></form>
          </table>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#BCE8B5">
            <tr>
              ...
              <td width="140" align="center" background="images/list_title_bg.jpg"><strong>品牌名称</strong></td>
              <td width="163" align="center" background="images/list_title_bg.jpg"><strong>排序</strong></td>
...
{
	$sqlwhere = " AND  name like '%$studentname%'";
}
...
$KeyWord = "";
		$countSql		= "SELECT a.* FROM  wkcx_content  as a,wkcx_class as b  where a.cat_id=b.id and b.type=brand $sqlwhere";//sql语句
		$pageSize		= "25"; //每页显示数
		...
		$sql 			= "SELECT a.* FROM wkcx_content  as a,wkcx_class as b    where a.cat_id=b.id and b.type=brand $sqlwhere  order by a.id DESC LIMIT $rsStart, $pageSize";
		$res			= $db->query($sql);
		$i = 1;
