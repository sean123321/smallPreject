<?php 
	...
	$sql = "SELECT * FROM wkcx_config  ORDER BY id LIMIT 1";
	$res = $db->query($sql);
	$row = $db->getarray($res);
?>
...
<tr bgcolor="#FFFFFF">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <input name="Submit2" type="submit" class="button" value="保存" onMouseMove="this.className='button-bor'" onMouseOut="this.className='button'" > 　　<input name="Submit2" type="submit" class="button" value="重置" onMouseMove="this.className='button-bor'" onMouseOut="this.className='button'">
                </td>
                </tr>
                </form>
<!--############################################################-->			
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#D2FFD2" style="border:1px solid #BCE8B5">
            <tr>
                 <td height="30" align="center" valign="bottom" background="images/index_bottom.jpg" style="background-repeat:no-repeat; background-position:bottom">技术支持：网科创想&nbsp;029-85458571&nbsp;<a href="http://www.xanet.net" target="_blank">www.xanet.net</a></td>
              </tr>
          </table>
...
<?php
	...
	if($act == 'save')
	{
		...
		$sql = "INSERT INTO wkcx_config(title,description,keywords,company,domain,author,jingtai) 
