...
$countSql="SELECT a.id FROM wkcx_content AS a,wkcx_class AS b WHERE a.cat_id=b.id $sqlwhere AND b.type='lunbo'";//sql语句
...
$sql = "SELECT a.id AS id,news_title,class_name,add_time,news_order,img_thumb FROM wkcx_content AS a,wkcx_class AS b WHERE a.cat_id=b.id $sqlwhere  AND b.type='lunbo' ORDER BY news_order ASC,add_time DESC LIMIT $rsStart, $pageSize";
$res = $db->query($sql);
$i = 1;
