...
$countSql="SELECT a.id FROM wkcx_content AS a,wkcx_class AS b WHERE a.cat_id=b.id AND b.type='friend'";//sql语句
$KeyWord = "";
$pageSize="20"; //每页显示数
...
$sql = "SELECT a.id AS id,news_title,class_name,add_time FROM wkcx_content AS a,wkcx_class AS b WHERE a.cat_id=b.id  AND b.type='friend' ORDER BY add_time DESC LIMIT $rsStart, $pageSize";
$res = $db->query($sql);
$i = 1;
