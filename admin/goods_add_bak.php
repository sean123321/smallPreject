...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> > 添加产品</td>
  </tr>
  <tr>
...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <tr style="display:none">
      ...
      <td bgcolor="#FFFFFF"><select name="brand_id" id="select2">
        ...
        <?php
                        ...
                        $sql = "SELECT * FROM wkcx_content WHERE cat_id='311' ORDER BY id DESC";
                        $res = mysql_query($sql);
                        while($row = mysql_fetch_array($res))
                        {
                			echo "<option value='".$row['id']."'>".$cut.$row['news_title']."</option>";
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>产品缩略图：</strong></td>
    ...
    <tr style="display:none">
      ...
      <td align="left" bgcolor="#FFFFFF">新品<input name="new" type="checkbox" value="1">  推荐<input name="recommend" type="checkbox" value="1">  促销<input name="promotion" type="checkbox" value="1"></td>
    </tr>
    <tr>
...
<?php
	...
	if($act == 'add')
	{
		...
		$img_thumb    = "";
		$small_img    = "";
		$news_order   = !empty($_POST['news_order'])? intval($_POST['news_order']) : '0';
		...
		$sql = "INSERT INTO wkcx_content(cat_id,
										news_title,
										news_desc,
										news_content,
										add_time,
