          ...
          <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FF9900">
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF"><select name="model" id="model">
                ...
                <option value="2">文字列表</option>
                <option value="3">图片列表</option>
                <option value="4">图文列表</option>
                <option value="5">图片轮换</option>
              </select>
              </td>
            </tr>
            <tr>
...
<?php
	...
	if($act == 'add')
	{
		...
		$pid = !empty($_POST['pid']) ? trim($_POST['pid']) : '';
	     ...
	     $sql = "INSERT INTO wkcx_class(class_name,class_order,pid,display,type,model) VALUES('$class_name','$class_order','$pid','$class_dis','$type','$model')";
