...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> > 下载管理</td>
  </tr>
  <tr>
    <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <option value="">请选择下载分类</option>
       			<?php
                    sub_class(227,"",$cat_id);
                    function sub_class($pid,$cut,$id)
                    {
                        $sql = "SELECT * FROM wkcx_class WHERE type='down' and pid='$pid' ORDER BY class_order ASC,id DESC";
                        $res = mysql_query($sql);
              ...
              <td width="80" align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
                  <tr>
                    ...
                    <td align="center"><p style="margin-top:3px"><a href="down_add.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">添加下载</a></p></td>
                  </tr>
              </table></td>
            </tr></form>
          </table>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#BCE8B5">
            <tr>
              ...
              <td align="center" background="images/list_title_bg.jpg"><strong>下载名称</strong></td>
              <td align="center" background="images/list_title_bg.jpg"><strong>下载限制</strong></td>
              <td width="100" align="center" background="images/list_title_bg.jpg"><strong>下载分类</strong></td>
...
$countSql="SELECT a.id FROM wkcx_content AS a,wkcx_class AS b WHERE a.cat_id=b.id $sqlwhere AND b.type='down'";//sql语句
...
$sql = "SELECT a.id AS id,xiazaiid,news_title,class_name,add_time,news_order,img_thumb FROM wkcx_content AS a,wkcx_class AS b WHERE a.cat_id=b.id $sqlwhere  AND b.type='down' ORDER BY news_order ASC,add_time DESC LIMIT $rsStart, $pageSize";
$res = $db->query($sql);
$i = 1;
...
?>            
            <tr <?=$style?>>
              ...
              <td align="left"> <?php if($row['xiazaiid']=='1') echo "仅正式会员下载"?><?php if($row['xiazaiid']=='0') echo "不限制";?> </td>
              ...
              <td align="center"><table width="60" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center">
                  <a href="down_upd.php?act=upd&id=<?=$row['id']?>&curPage=<?=$curPage?>&<?=$KeyWord?>">
...
$url = "down_list.php?curPage=".$curPage."&".$urlPara."";
if($act == 'del'){
